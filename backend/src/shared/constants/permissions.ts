...
export const PERMISSION_MODULES: PermissionModuleDefinition[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      },
      {
        ...
        example: "Create “Widget XL” with 800 pieces per box and threshold 5 boxes.",
      },
    ],
  },
  {
  ...
  },
  {
    id: "imports",
    label: "Tally import",
    description: "Bulk import sales or stock data from Tally exports.",
    warehouseScoped: false,
    permissions: [
      {
        code: Permission.IMPORTS_MANAGE,
        label: "Run Tally imports",
        description: "Upload and process Tally files to update stock.",
        example: "Import yesterday’s Tally sales file to sync stock out.",
      },
    ],
  },
  {
